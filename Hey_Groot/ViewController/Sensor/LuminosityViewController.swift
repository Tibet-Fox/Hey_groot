               ...
               if let latestData = jsonDataObject.datas.last {
                   DispatchQueue.main.async {
                       // Update UI elements with the latest data
                          ...
                          let attributedText = NSMutableAttributedString(string: "Luminosity: ", attributes: boldAttributes)
                          
                          // Append the non-bold part of the text
                          attributedText.append(NSAttributedString(string: "\(latestData.light) E"))
                          
                          self.sensorLabel.attributedText = attributedText
                       
                       // Assuming sensorLabel is not added to the view hierarchy programmatically
